...
Use `python ai-agent/runtime/load-memory.py --include-quality --keys self-critique,review-checklist` for runtime context.
...
| Skill registry | `.agents/registry.yaml` — `impeccable-reviewer` |
