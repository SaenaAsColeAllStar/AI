...
> **Pair with**: `assurance/insecure-defaults.md`, `quality/engineering-principles.md`
...
Maintain rules under `.semgrep/` or `security/semgrep/` (when created). Priority rules:
...
- `assurance/dependency-review.md`
