...
Product review (`quality/product-principles.md`) runs **before** Architecture — during brainstorming and PRD — but is not repeated as a separate ship gate if PRD sign-off exists.
...
**Required artifact**: Assurance Sign-Off in plan (`assurance/review-workflow.md`)
...
**Skills / docs**: `assurance/assurance-principles.md`, `assurance/review-workflow.md`, `assurance/risk-analysis.md`
...
**Artifacts**: `quality/ux-principles.md`, `quality/design-taste.md`
...
- `security/rbac-security.md` checklist pass

**Checklist sections**: 9 (RBAC), 5.3 (API permissions), `security/review-checklist.md` §2
...
**Artifacts**: `security/security-gates.md`, `security/review-checklist.md`
...
Before declaring any gate passed or task complete, run `quality/self-critique.md`. Failure on self-critique reopens the relevant gate.
...
- Artifact index: `quality/quality-registry.yaml`
- Review agent: `agents/impeccable-reviewer.md`
- Runtime load: `python ai-agent/runtime/load-memory.py --include-quality`
