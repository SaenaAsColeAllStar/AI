...
> **Registry**: `execution/execution-registry.yaml` → `retry_policies`  
...
Cross-ref: `execution/deployment-mode.md`
...
| Issue | Action |
|-------|--------|
| Install interrupted | `bash bootstrap/recover.sh` |
| Ollama down | `bash bootstrap/start-ollama.sh` |
...
| Doc | Purpose |
|-----|---------|
| `docs/ai/AI_EXECUTION_SYSTEM.md` | Full V2 spec |
| `.agents/EXECUTION.md` | Agent bootstrap |
| `AI_RECOVERY.md` | Workstation restore |
| `quality/self-critique.md` | Pre-completion verification |
