...
|----------|--------------|
| `taste/ux-principles.md` | Label placement and hierarchy |
| `taste/product-principles.md` | Feature naming scope |
| `quality/ux-principles.md` | a11y includes readable copy |
| `taste/taste-gates.md` | Gate 5 — Copywriting Taste |
