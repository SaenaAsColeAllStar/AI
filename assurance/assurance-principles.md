...
|--------|----------|---------------|
| Requirement clarity | `assurance/decision-validation.md` | `agents/requirement-clarifier.md` |
| Context completeness | `agents/context-builder.md` | Reads ADR, PRD, RBAC, DB standards |
| Change review | `assurance/review-workflow.md` | `agents/differential-reviewer.md` |
| Risk identification | `assurance/risk-analysis.md` | All assurance agents |
| Sharp edges | `assurance/sharp-edges.md` | Pre-implementation gate |
| Insecure defaults | `assurance/insecure-defaults.md` | Before Security layer sign-off |
| Supply chain | `assurance/dependency-review.md` | New deps, CI, MCP integrations |
| Static analysis | `assurance/static-analysis.md` | Pre-PR and pre-deploy |
| Second opinion | `agents/second-opinion-reviewer.md` | Plans, architecture, deploy |

Cross-reference: `security/security-principles.md` for policy; assurance is **proactive audit**, security is **mandatory policy**.
...
Detail: `assurance/review-workflow.md`, `assurance/assurance-registry.yaml`
...
| Resource | Path |
|----------|------|
| System index | `docs/ai/AI_ASSURANCE_SYSTEM.md` |
| Registry | `assurance/assurance-registry.yaml` |
| Master rules | `AGENTS.md` — Assurance Layer |
| Memory loader | `python ai-agent/runtime/load-memory.py --include-assurance` |
