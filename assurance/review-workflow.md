...
> **Index**: `docs/ai/AI_ASSURANCE_SYSTEM.md`
...
Discovery
    ↓
Taste Layer (5 gates)                    ← taste/taste-gates.md
    ↓
...
Plan authoring                           ← superpowers-writing-plans
    ↓
Assurance Review (this workflow)         ← assurance/* + second-opinion-reviewer
    ↓
...
Impeccable Quality Review                ← agents/impeccable-reviewer.md
    ↓
Self-critique + Quality gates            ← quality/self-critique.md, quality-gates.md
    ↓
...
**Load**: `assurance/decision-validation.md`, `assurance-bundle planning`
...
**Load**: `memory/architecture-decisions.md`, relevant ADR, PRD sections
...
**Document**: `assurance/decision-validation.md`  
...
**Document**: `assurance/risk-analysis.md`  
**When**: Plan draft complete
...
**Document**: `assurance/sharp-edges.md`  
...
**Document**: `assurance/static-analysis.md`  
...
- Cross-check `security/security-gates.md` + `quality/quality-gates.md`
...
```text
assurance/review-workflow.md (Phases A–E)
    → security/security-gates.md
    → taste/taste-gates.md (re-check if UI changed)
...
python ai-agent/runtime/load-memory.py --include-assurance --assurance-bundle planning
...
# PR / diff review
python ai-agent/runtime/load-memory.py --include-assurance --assurance-bundle differential

# Before deploy
python ai-agent/runtime/load-memory.py --include-assurance --assurance-bundle pre-deploy

# Combined with quality + security context
python ai-agent/runtime/load-memory.py --include-assurance --include-quality --assurance-bundle pre-implementation --quality-bundle pre-code

# Full assurance context (heavy)
python ai-agent/runtime/load-memory.py --include-assurance --assurance-bundle full
```
...
3. Document in `memory/lessons-learned.md`
...
| Document | Role |
|----------|------|
| `assurance/assurance-principles.md` | Philosophy and severity |
...
| `security/security-gates.md` | Next mandatory gate |
| `quality/quality-gates.md` | Post-implementation gates |
| `taste/taste-gates.md` | Pre-assurance judgement layer |
