...
> **Layer**: Taste (judgement & restraint) — precedes `quality/ux-principles.md`  
> **Role**: Design director filter on *how little interface* achieves the task  
> **Sources**: `memory/ui-ux-rules.md`, `quality/design-taste.md`, Teknovo sidebar IA
...
|----------|--------------|
| `quality/ux-principles.md` | Page states, a11y, formal UX bar |
| `quality/design-taste.md` | Visual anti-patterns |
| `memory/ui-ux-rules.md` | Tokens, typography, components |
| `taste/design-principles.md` | Visual restraint |
| `taste/taste-gates.md` | Gate 2 — UX Taste |
