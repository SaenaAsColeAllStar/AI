...
> **Full spec**: `docs/ai/AI_EXECUTION_SYSTEM.md`  
> **Registry**: `execution/execution-registry.yaml`

Agents in **execution mode** load this file immediately after `AGENTS.md` / `.agents/AGENTS.md`.

---

## Model: qwen3:32b (Required)

| Required | `qwen3:32b` (pinned in `bootstrap/install.lock.yaml`) |
...
3. Reference `AI_RUNTIME.md` and `bootstrap/install-model.sh`.
...
Detail: `execution/deployment-mode.md` · Skill: `teknovo-cloudflare-stack`
