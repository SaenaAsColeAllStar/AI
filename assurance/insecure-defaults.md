...
> **Cross-ref**: `security/security-principles.md`, `security/api-security.md`, `security/rbac-security.md`  
...
| Aspect | Assurance (`insecure-defaults.md`) | Security (`security/*`) |
|--------|-----------------------------------|-------------------------|
...
Reference: `security/ai-agent-security.md` (when present)
...
| Next step | Document |
|-----------|----------|
| Security policy detail | `security/security-principles.md` |
| API controls | `security/api-security.md` |
