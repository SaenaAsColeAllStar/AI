...
4. Run `quality/self-critique.md` before final sign-off
...
**Reference**: `quality/product-principles.md`
...
**Reference**: `quality/ux-principles.md`, `quality/design-taste.md`, `memory/ui-ux-rules.md`
...
**Reference**: `quality/architecture-principles.md`
...
**Reference**: `teknovo-database-architect`, `memory/coding-standards.md`
...
**Reference**: `teknovo-security-review`, `security/review-checklist.md`, `agents/security-reviewer.md`
...
See `quality/quality-gates.md` for mandatory gate order.
