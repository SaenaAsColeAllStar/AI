...
3. Optional local `mcp/cloudflare/.env` (development fallback only)
...
- `mcp/cloudflare/docs/SECRET_STORE.md` — Cloudflare MCP integration
- `registry/mcp-registry.yaml` — MCP activation and secret paths
