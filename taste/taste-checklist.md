...
> **Use with**: `agents/taste-reviewer.md`, `taste/taste-gates.md`  
> **Precedence**: Complete taste checklist **before** `quality/review-checklist.md`
...
Reference: `taste/product-principles.md`
...
Reference: `taste/ux-principles.md`
...
Reference: `taste/design-principles.md`, `memory/ui-ux-rules.md`
...
Reference: `taste/architecture-principles.md`
...
Reference: `taste/copywriting-principles.md`
...
```bash
python ai-agent/runtime/load-memory.py --include-taste --include-quality --taste-bundle pre-feature --quality-bundle planning
```

Then run `quality/quality-gates.md` and Three Pillars gates as applicable.
...
| Document | Role |
|----------|------|
| `taste/taste-gates.md` | Mandatory gate sequence |
| `agents/taste-reviewer.md` | Review agent |
| `quality/review-checklist.md` | Post-taste quality bar |
| `quality/self-critique.md` | Final output critique |
