# Product Excellence Principles — Teknovo Impeccable Architect

> **Scope**: Every feature proposal, PRD section, module expansion, and scope change  
> **Authority**: Pillar 1 — Chief Product Designer; Master PRD (`docs/prd/master/master-prd.md`)  
...
Teknovo ERP serves schools with daily operational workflows — PPDB admissions, academic records, finance billing, CBT exams, WhatsApp notifications. Product decisions must reduce staff workload and increase data trust, not accumulate features for feature parity.
...
- Workflow fits existing ERP mental model — not a standalone mini-app
...
| Conversion | Improves landing → demo → contract funnel |
...
Score each factor 1 (low) – 5 (high):
...
**Question**: Who maintains this in year two — and what breaks when requirements shift?
...
| Review | `quality/review-checklist.md` — Product section |
| Ship | No feature ships without documented success metric or acceptance criteria |

**Related**: `quality/quality-gates.md`, `quality/self-critique.md`, `.agents/skills/teknovo-chief-product-designer/SKILL.md`
