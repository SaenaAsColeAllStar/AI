...
> **Pair with**: `assurance/risk-analysis.md`, `assurance/insecure-defaults.md`
...
- **Static analysis**: Custom Semgrep rules for known edges (see `assurance/static-analysis.md`)
...
- `assurance/risk-analysis.md`
- `taste/architecture-principles.md`
