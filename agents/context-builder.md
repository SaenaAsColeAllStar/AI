...
python ai-agent/runtime/load-memory.py --keys architecture-decisions,coding-standards,ui-ux-rules,domain-knowledge
```
...
2. `.agents/registry.yaml` — applicable skills
