...
5. Cross-check `quality/review-checklist.md` section 6 (Security) — both must align

**CLI context**: `python ai-agent/runtime/load-memory.py --include-security --security-bundle full`
...
**Reference**: `security/api-security.md`, `teknovo-security-review`
...
**Reference**: `security/rbac-security.md`, `teknovo-rbac-architect`
...
**Reference**: `security/api-security.md`
...
**Reference**: `security/database-security.md`
...
**Reference**: `security/security-principles.md`, `security/ai-agent-security.md`
...
**Reference**: `security/cloudflare-security.md`, `teknovo-security-review`
...
**Reference**: `security/cloudflare-security.md`, `memory/architecture-decisions.md`
...
**Reference**: `security/ai-agent-security.md`
...
- Quality cross-check: `quality/review-checklist.md` §6
- Skill: `.agents/skills/teknovo-security-review/SKILL.md`
