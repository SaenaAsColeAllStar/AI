...
> **Precedence**: Assurance Review (`assurance/review-workflow.md`) → **Security Gates** → Implementation  
> **Registry**: `security/security-principles.md` (index)
...
When security and convenience conflict, **security wins** (see `security/security-principles.md`).
...
```text
Assurance Sign-Off (assurance/review-workflow.md)
    ↓
...
6. Supply Chain (if new deps — cross-ref assurance/dependency-review.md)
    ↓
...
| **Documents** | `security/security-principles.md`, module threat notes |
...
| Field | Value |
|-------|-------|
| **Document** | `security/rbac-security.md` |
...
| Field | Value |
|-------|-------|
| **Document** | `security/api-security.md` |
...
| Field | Value |
|-------|-------|
| **Document** | `security/database-security.md` |
...
| Field | Value |
|-------|-------|
| **Document** | `security/cloudflare-security.md` |
...
- Static analysis CI green (`assurance/static-analysis.md`)
...
| Document | Role |
|----------|------|
| `assurance/review-workflow.md` | Precedes this layer |
| `assurance/insecure-defaults.md` | Proactive input to Gate 1 |
| `quality/quality-gates.md` | Follows implementation |
