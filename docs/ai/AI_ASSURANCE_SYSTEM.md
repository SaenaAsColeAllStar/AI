...
| Before plan finalization | `agents/context-builder.md`, `assurance/review-workflow.md` |
...
**CLI**: `python ai-agent/runtime/load-memory.py --include-assurance`  
...
|----------|------|---------|
| Assurance principles | `assurance/assurance-principles.md` | Philosophy, precedence, severity |
| Review workflow | `assurance/review-workflow.md` | Phases A–E, GStack, CLI |
| Risk analysis | `assurance/risk-analysis.md` | Risk register, domain catalog |
| Decision validation | `assurance/decision-validation.md` | Assumptions, alternatives, conflicts |
| Sharp edges | `assurance/sharp-edges.md` | Dangerous APIs, fragile abstractions |
| Insecure defaults | `assurance/insecure-defaults.md` | Proactive audit before security gate |
| Dependency review | `assurance/dependency-review.md` | Supply chain, Actions, MCP |
| Static analysis | `assurance/static-analysis.md` | Semgrep, CodeQL, CI strategy |
| Registry | `assurance/assurance-registry.yaml` | Paths, bundles, agents |
...
Plan                          ← superpowers-writing-plans
    ↓
Assurance Review (mandatory)  ← assurance/* + second-opinion (if high-risk)
    ↓
...
python ai-agent/runtime/load-memory.py --include-assurance --assurance-only

# Combined with quality
python ai-agent/runtime/load-memory.py --include-assurance --include-quality \
...
| Taste | `docs/ai/AI_TASTE_SYSTEM.md` |
| Security | `docs/ai/AI_SECURITY_SYSTEM.md` |
| Quality | `docs/ai/AI_QUALITY_SYSTEM.md` |
