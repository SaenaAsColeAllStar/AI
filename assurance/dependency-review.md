...
> **Pair with**: `assurance/static-analysis.md`, `security/security-principles.md`
...
| **Python** | `ai-agent/runtime`, scripts | New pip/poetry dep |
...
| Vendor | Document in `memory/lessons-learned.md` |
...
6. **Monitor** — Add to quarterly audit list in plan or `memory/lessons-learned.md`
...
| Document | Role |
|----------|------|
| `assurance/static-analysis.md` | SAST for vendored patterns |
| `assurance/decision-validation.md` | Alternatives considered |
...
- `assurance/review-workflow.md`
- `assurance/insecure-defaults.md`
