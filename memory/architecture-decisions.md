...
> **Source**: `docs/ai/repository-analysis.md`, `teknovo-chief-architect`, `teknovo-cloudflare-stack`, `teknovo-repository-governance`, `teknovo-devops-engineer` skills; Teknovo-V2 ADRs referenced but not present in AI repo  
...
> **Version note**: This AI repo references **Nuxt.js** for `apps/portal/` (`docs/ai/repository-analysis.md`, `.agents/AGENTS.md`). Specific Nuxt major version (e.g., Nuxt 4) is defined in Teknovo-V2 `package.json`, not in this workstation repo.
...
See `memory/ui-ux-rules.md` for full rationale. Summary:
