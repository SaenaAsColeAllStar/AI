...
> **Layer**: Taste (judgement & restraint) — precedes `quality/product-principles.md`  
...
|----------|--------------|
| `quality/product-principles.md` | Quality bar after taste approves scope |
| `taste/taste-gates.md` | Gate 1 — Product Taste |
| `taste/taste-checklist.md` | Removal and simplification questions |
