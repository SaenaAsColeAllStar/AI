...
|---------------|----------|-------|
| Skill definitions | `.agents/skills/**/SKILL.md` | {counts["total"]} |
| Superpowers skills | `.agents/skills/superpowers/` | {counts["superpowers"]} |
| GStack skills | `.agents/skills/gstack/` | {counts["gstack"]} |
| Teknovo skills | `.agents/skills/teknovo-*/` | {counts["teknovo"]} |
| AI documentation | `docs/ai/` | {len(doc_files)} |
| Memory artifacts | `memory/` | {len(memory_files)} |
