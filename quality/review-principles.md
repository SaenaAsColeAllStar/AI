...
> **Engine**: `quality/review-checklist.md` + `agents/impeccable-reviewer.md`  
...
Critical and Major issues require resolution before `quality/quality-gates.md` sign-off.
...
|--------|------|-------------------|
| Product | After brainstorming / PRD draft | `quality/product-principles.md` |
| UX | Before UI code; pre-release | `quality/ux-principles.md`, `quality/design-taste.md` |
| Architecture | Before migrations / new modules | `quality/architecture-principles.md` |
| Engineering | During PR; before merge | `quality/engineering-principles.md` |
| Full stack | Before ship | `quality/review-checklist.md` |
...
- Before deploy (`quality/quality-gates.md`)
- When user asks for "review", "audit", or "quality check"

**Agent definition**: `agents/impeccable-reviewer.md`

For scope and removal reviews first, invoke `agents/taste-reviewer.md` and `taste/taste-gates.md`. Precedence: **Taste > Quality** (`taste/taste-registry.yaml`).
