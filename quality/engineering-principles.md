# Engineering Excellence Principles — Teknovo Impeccable Architect

> **Authority**: Coding Standard, `memory/coding-standards.md`, `teknovo-backend-development`, `teknovo-feature-implementation`  
...
| Reporting | Read replicas / materialized views — not OLTP scans |
...
- E2E only — no unit tests for calculation logic
...
Evidence required — see `superpowers-verification-before-completion`.
...
| Artifact | Use |
|----------|-----|
| `quality/review-checklist.md` | Engineering + Security sections |
| `quality/quality-gates.md` | Testing Review gate |
| `.agents/skills/gstack-eng-review/SKILL.md` | Layer audit |
| `.agents/skills/teknovo-security-review/SKILL.md` | Security pass |
