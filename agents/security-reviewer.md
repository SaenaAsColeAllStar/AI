...
python ai-agent/runtime/load-memory.py --include-security --security-bundle pre-deploy
```
...
| Skill registry | `.agents/registry.yaml` — `security-reviewer` |
| Tactical skill | `.agents/skills/teknovo-security-review/SKILL.md` |
