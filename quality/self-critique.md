# Self-Critique System — Teknovo Impeccable Architect
...
> **Taste first**: Run `taste/taste-checklist.md` before this critique when scope/UI changed — taste precedes quality (see `docs/ai/AI_TASTE_SYSTEM.md`)
...
If any would reject — **refine before presenting as done**.

**Security self-check**: Run `security/review-checklist.md` applicable sections or `python ai-agent/runtime/load-memory.py --include-security --security-bundle planning` before claiming implementation-ready.
...
### Principal approval?
- Architect would approve: ☐ Yes ☐ No — fix:
- Designer would approve: ☐ Yes ☐ No — fix:
...
```text
Implement → tsc/lint/test → self-critique → quality gates → ship
```
...
- `taste/taste-checklist.md` — run first for scope/simplicity (Taste > Quality)
- `assurance/review-workflow.md` — reopen if self-critique reveals unverified assumptions
- `docs/ai/AI_ASSURANCE_SYSTEM.md` — assurance layer checkpoint
- `docs/ai/AI_TASTE_SYSTEM.md` — taste layer precedence
- `quality/quality-gates.md`
- `quality/review-checklist.md`
- `agents/impeccable-reviewer.md`
- `security/review-checklist.md` — security self-check
- `docs/ai/AI_SECURITY_SYSTEM.md`
